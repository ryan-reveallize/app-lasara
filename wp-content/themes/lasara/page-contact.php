...
<div class="main-container mt-4r">
      <section class="bg-grad-2">
        <div class="container">
          <div class="row align-items-end align-items-lg-center pt-lg-5">
            <div class="col-xxl-5 col-md-6 py-5 ps-sm-4 mb-sm-5">
              <h1 class="text-white font-black">Contact Us</h1>
              <h4
                class="font-light line-height-lg text-white mt-4 mb-5 line-height-lg"
              >
                LaSara Medical Group specializes in helping men who suffer from
                erectile dysfunction (ED).
              </h4>
            </div>
            <div class="offset-xxl-1 col-md-6">
              <img
              ...
              <div class="mb-3">
                ...
                <div class="mb-3">
                  <label for="comment" class="form-label"
                    >Comments <span class="text-secondary">*</span></label
                  >
                  <textarea
                    name="comment"
                    id="comment"
                ...
                <div class="my-4">
                  <input type="checkbox" id="agree" class="btn-check" />
                  <label for="agree" class="form-check-label"
                    ...
                    messaging system. This form should not be used to transmit
                    private health information, and we disclaim all warranties
                    with respect to the privacy and confidentiality of any
                    information submitted through this form.</label
                  >
                </div>
                <button type="submit" class="btn btn-primary mw-200">
                  Send
                </button>
              </form>
            </div>
