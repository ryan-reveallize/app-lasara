...
<div class="main-container mt-4r">
      <section
        ...
        data-background-image="<?php bloginfo('template_directory')?>/img/bg-flow.jpg"
      >
        ...
        <div class="container-fluid">
          <div class="row align-items-center">
            <div class="col-md-5 offset-md-1 pe-lg-5">
              ...
              >
                <img
                  src="<?php bloginfo('template_directory')?>/img/flow-side2.jpg"
                  alt="Old Couple"
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-6 ps-4">
              <div
                class="bg-img-overlay-sm-left sticky-top border-r-1 mb-5 mb-md-0 bg-img-overlay-sm-left"
              >
                <img
                  src="<?php bloginfo('template_directory')?>/img/flow-side.jpg"
                  alt="Old Couple"
                  class="img-fluid border-r-1"
                />
              </div>
      ...
      <section
        ...
        data-background-image="<?php bloginfo('template_directory')?>/img/looking-each-other.jpg"
      >
