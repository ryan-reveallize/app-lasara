...
<div class="main-container mt-4r">
      <section
        class="bg-img bg-overlay bg-overlay-left-full py-5 bg-center"
        data-background-image="<?php bloginfo('template_directory')?>/img/relaxing.jpg"
      >
      ...
      <section class="py-5">
        <div class="container">
          <div
            ...
            data-background-image="<?php bloginfo('template_directory')?>/img/penile-injection-intro.jpg"
          ></div>
