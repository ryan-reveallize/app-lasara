...
<div class="main-container mt-4r">
      <section
        class="bg-img bg-overlay-left-full py-5 bg-center"
        data-background-image="<?php bloginfo('template_directory')?>/img/bg-pt.jpg"
      >
        ...
        <div class="container-fluid">
          <div class="row align-items-center">
            ...
            <div class="col-md-5 ps-lg-5">
              ...
              >
                <img
                  src="<?php bloginfo('template_directory')?>/img/pt-side.jpg"
      ...
      <section
        ...
        data-background-image="<?php bloginfo('template_directory')?>/img/pt-side2.jpg"
      >
