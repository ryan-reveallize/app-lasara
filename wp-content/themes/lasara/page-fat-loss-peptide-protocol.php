        ...
        <div class="container-fluid py-5 my-xl-5 z-1 cross-vertical-right">
          <div class="row py-lg-5">
            <div class="col-xl-4 col-md-6 offset-md-1">
              <h1 class="text-white mb-5">Support Your Weight Loss Journey</h1>
            </div>
            <div class="w-100"></div>
        ...
        <div class="container">
          <div class="row align-items-start">
            ...
            <div class="col-xl-6 col-lg-6 ps-lg-5 pt-lg-5 mb-5">
              <p>
                Peptides are naturally occurring biological molecules that
                contain two or more amino acids connected by peptide bonds. Like
                amino acids and proteins, peptides fuel several crucial
                processes in the body like hormone production, healing, and fat
                loss. Medical advancements in understanding the function of
                peptides reveal that supplying the body with additional specific
                peptides can help enhance desired functions and provide stronger
                outcomes.
              </p>
              <p>
                Over many years of research, our medical partners have
                discovered that peptides work best when administered together in
                specific combinations to enhance the synergy and effectiveness
                of each peptide. For this reason, LaSara Medical Group offers a
                beneficial combination of peptides in the Fat Loss Peptide
                Protocol. The Fat Loss Peptide Protocol includes our most
                popular peptide blend of Tesamorelin, CJC 1295/ 1pamorelin, and
                BPC 157 formulated to shrink both subcutaneous and visceral fat.
              </p>
            </div>
            <div class="col-md-2 col-lg-2 offset-lg-4">
              <h3 class="text-dark">Tesamorelin</h3>
              <p>
                Tesamorelin helps the human body retain calcium, increase
                protein synthesis and muscle growth, and increase the breakdown
                of fat. Clinical trials show that Tesamorelin has been shown to
                reduce the visceral fat surrounding the internal organs. Much of
                the abdominal obesity we see in adults today arises from
                visceral fat. Tesamorelin has also been shown to increase one’s
            ...
            <div class="col-md-2 col-lg-2">
              ...
              <p>
                CJC 1295 and Ipamorelin is a combination of 2 peptides. This
                growth hormone-producing mechanism holds many benefits like
                strengthening the cardiovascular system and bone density,
                increasing the body’s ability to lose fat, increasing sex drive,
                and improving the immune system and insulin sensitivity, thus
                reducing the body’s triglycerides.
              </p>
            </div>
            <div class="col-md-2 col-lg-2">
              <h3 class="text-dark">BPC-157</h3>
              <p>
                Composed of 15 amino acids, BPC-157 is a partial sequence of
                body protection compounds (BPC) discovered in and isolated from
                human gastric juice. This peptide helps repair intestinal damage
                like fistulas and inflammation, increases cellular regeneration,
                reduces muscle waste, and promotes muscular development.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              >
                <div class="col-md-6 col-xl-5 pt-5 pb-md-5 pe-xl-5">
                  ...
                  <p class="text-white">
                    If you are looking to lose belly fat and trim down, the Fat
                    Loss Peptide Protocol at LaSara Medical Group is the
                    protocol for you. Benefits of this protocol include:
                  </p>
                </div>
                <div class="col-md-6 col-xl-5 py-5">
                  <ul class="list-check-grad text-white">
                    ...
                    <li>Increases metabolism and mitochondrial function</li>
                  ...
                  >
                    ...
                    >
                      <div class="accordion-body">
                        LaSara Medical Group’s Fat Loss Peptide Protocol is
                        suitable for both men and women who are looking for
                        additional support in their weight loss journey. If you
                        are unsure whether you would make a good candidate for
                        our peptide protocols, don’t hesitate to make an
                        appointment with our knowledgeable and helpful staff at
                        any of our locations. Your weight loss journey is only a
                        phone call away!
                      </div>
                    </div>
                  </div>
