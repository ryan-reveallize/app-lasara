...
<div class="main-container mt-4r">
      <section
        class="bg-img bg-overlay-left-full py-5 bg-top bg-overlay-left-full"
        data-background-image="<?php bloginfo('template_directory')?>/img/bg-recovery.jpg"
      >
        ...
        <div class="container-fluid">
          <div class="row align-items-center">
            <div class="col-md-5 offset-md-1 pe-lg-5">
              ...
              >
                <img
                  src="<?php bloginfo('template_directory')?>/img/recovery-side.jpg"
                  alt="Old Couple"
      ...
      <section
        ...
        data-background-image="<?php bloginfo('template_directory')?>/img/recovery-side2.jpg"
      >
